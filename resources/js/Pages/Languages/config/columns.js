 ...
 */
export const languagesTableColumns = (t) => [
    { title: '★',                    dataIndex: 'is_favorite', key: 'favorite',  width: 48,  alwaysVisible: true, mobile: { role: 'pin' } },
    { title: t('languages.id'),        dataIndex: 'id',          key: 'id',         sorter: true, width: 80,  alwaysVisible: true, mobile: { role: 'hidden' } },
    { title: t('languages.name'),      dataIndex: 'name',        key: 'name',       sorter: true, ellipsis: true, alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('languages.iso_code'),  dataIndex: 'iso_code',    key: 'iso_code',   sorter: true, width: 110, alwaysVisible: true, mobile: { role: 'subtitle' } },
