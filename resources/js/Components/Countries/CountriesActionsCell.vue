...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile">
        <Tooltip :title="t('global.view')">
            <Link :href="route('system_management.countries.show', record.slug)">
                <Button
                    type="text"
                    class="row-icon-btn"
    ...
    <Space v-else size="small" class="row-actions-desktop">
        ...
        <Tooltip v-if="canEdit" :title="t('global.edit')">
            <Link :href="route('system_management.countries.edit', record.slug)">
        ...
        <Tooltip v-if="canDelete" :title="t('global.delete')">
            <Link :href="route('system_management.countries.delete', record.slug)">
