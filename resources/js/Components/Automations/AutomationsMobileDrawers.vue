 ...
 *
 * Export/Import disponibles — emiten open-export / open-import al padre,
 * que abre los respectivos dialogs reusables (ExportDialog / ImportDialog).
 */
...
// Helper: cierra el drawer de Otros antes de disparar la acción.
