...
abstract class CustomerTestCase extends TestCase
{
    ...
    protected function seedParentRows(): void
    {
        ...
        // Plan enterprise para que los tests no choquen contra plan_feature
        // middlewares (export_*, bulk_operations, etc). Idem patron UserTestCase.
        ...
        // Suscripcion enterprise activa para ambos tenants — desbloquea todas
        // las features (export_*, bulk_operations, imports). Sin esto los
        // tests de bulk/export chocan contra plan_feature middlewares.
    ...
    protected function seedRolesAndPermissions(): void
    {
        ...
        foreach (['customers.view', 'customers.create', 'customers.edit', 'customers.delete', 'customers.show'] as $perm) {
    ...
    /**
     * Crea + autentica un super SIN tenant_id (alineado con el modelo de
     * acceso: super no pertenece a ningun tenant y ve cross-tenant).
     */
